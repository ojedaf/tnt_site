    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ...
          ['EK-92 <br> (1-Shot)', 0, 39.10, 0, 0, 0, 42.33, 46.13],
          ['EK-92 <br> (5-Shot)', 0, 52.30, 0, 0, 0, 52.66, 59.00],
          ['SS-100 <br> (1-Shot)', 0, 33.60, 34.40, 38.60, 42.80, 39.28, 50.44],
          ['SS-100 <br> (5-Shot)', 0, 43.00, 43.80, 48.90, 52.30, 52.63, 59.04],
          ['MetaUCF-101 <br> (1-Shot)', 62.1, 76.4, 0, 0, 0, 79.23, 86.66],
          ['MetaUCF-101 <br> (5-Shot)', 84.8, 88.5, 0, 0, 0, 90.08, 94.14],
          ['Kinetics-100 <br> (1-Shot)', 63.7, 64.5, 65.4, 68.4, 73.0, 68.0, 78.02],
          ['Kinetics-100 <br> (5-Shot)', 82.4, 77.9, 78.8, 82.0, 85.8, 79.87, 84.82]
        ]);
